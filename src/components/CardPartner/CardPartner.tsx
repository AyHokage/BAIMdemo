  ...
  return ( 
    <div className={styles.flip}>
        <div className={styles.front}>
           <ExportedImage className={styles.img} width={300} height={300} src={image} alt='logo' />
        ...
        <div className={styles.back}>
           <ExportedImage className={styles.imgMini} width={300} height={300} src={image} alt='logo' />
